...
int build_incremental_index(const std::string& data_path, const unsigned L,
  ...
  for (unsigned i = 0; i < rounds; i++) {
    ...
    std::cout << "Inserting " << insert_size << " points" << std::endl;
    ...
    std::cout << "Insertion time " << insert_timer.elapsed() / 1000 << "ms\n";
    ...
    std::cout << "Number of points in the index post insertion " << num_curr_pts
              << std::endl;
    insert_list.clear();
    ...
    std::cout << "Deleting " << delete_size << " points from the index"
              << std::endl;
    ...
    std::cout << "Delete time in this phase " << del_timer.elapsed() / 1000
              << "ms\n";
    deleted_tags.clear();
    inserted_tags.clear();
    ...
    std::cout << "Number of points in the graph currently = " << num_curr_pts
              << std::endl;
  }
